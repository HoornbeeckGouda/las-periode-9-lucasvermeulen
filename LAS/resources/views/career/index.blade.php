            ...
            <div class="bg-white border-gray-800 border-2 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between space-x-20 w-full">
                        <div class="w-full">
                            <button> <a href="{{ route('careers.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Career</a></button>
                            <table>
                                <tr>
                                    <th>Student</th>
                                    <th>Course</th>
                                ...
                                @foreach($careers as $career)
                                    <tr>
                                        ...
                                        <td>{{$career->schoolYear()->get()->first()->year}}</td>                                    </tr>
                                @endforeach
                            </table>
                        </div>
                    </div>
